...
const suggestions = [
  {
    ...
    detail: "Add a dedicated skills section listing your top 8–12 technical skills.",
  },
  {
    type: "warning",
    icon: AlertCircle,
    ...
    detail: "Include role-specific keywords like TypeScript, CI/CD, and system design.",
  },
  {
    type: "warning",
    icon: AlertCircle,
    ...
    detail: "Quantify impact — e.g. 'Reduced load time by 40%' instead of 'Improved performance'.",
  },
  {
    type: "good",
    icon: CheckCircle,
          ...
          <div className="glass-card rounded-2xl p-6 flex flex-col items-center text-center gap-4 h-full">
            ...
            <div>
              ...
              <div className="mt-3 relative w-36 h-36 mx-auto">
                <svg className="w-full h-full -rotate-90" viewBox="0 0 120 120">
                  <circle cx="60" cy="60" r="50" stroke="#1f2338" strokeWidth="10" fill="none" />
                  <circle
                    cx="60"
                    cy="60"
                    r="50"
            ...
            <div className="w-full pt-2 border-t border-white/5">
              <p className="text-zinc-400 text-xs">
                ...
                <span className="text-violet-400 font-bold">top 26%</span> of candidates.
              </p>
            </div>
          </div>
        </Grid>
