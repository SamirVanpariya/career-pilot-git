...
import { Mail, ArrowRight, Zap, CheckCircle2, TrendingUp, Shield, Users } from "lucide-react";
        ...
        <div className="z-10 space-y-8">
          <div>
            <h2 className="text-3xl font-black text-white leading-tight mb-3">
              Recover your account<br />in <span className="gradient-text">seconds</span>
            </h2>
          ...
          {submitted ? (
            <div className="text-center py-8">
              <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 border"
                ...
                <CheckCircle2 className="w-8 h-8" style={{ color: "var(--color-orange)" }} />
              </div>
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                <div>
                  <label className="text-zinc-400 text-xs font-semibold uppercase tracking-wider block mb-1.5">Email Address</label>
                ...
                <button type="submit" disabled={loading || !email}
                  className={`btn-primary !w-full !justify-center !h-11 mt-1 ${(!email || loading) ? "opacity-50 cursor-not-allowed" : ""}`}>
